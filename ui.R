...
about_panel <- tabPanel(
    ...
    fluidRow(column(10,
        ...
        tags$i(" Bioinformatics and Biomedicine (BIBM), 2015 IEEE International Conference on "),
        tags$br(),
        tags$span("DOI: "),
        a('10.1109/BIBM.2015.7359689', href='http://dx.doi.org/10.1109/BIBM.2015.7359689'),
        tags$span("PMID: "),
        a('26848405', href='http://www.ncbi.nlm.nih.gov/pubmed/26848405'),
        tags$span("PMCID: "),
        a('PMC4737646', href='http://www.ncbi.nlm.nih.gov/pmc/articles/PMC4737646/')
        , offset=1)),
    fluidRow(column(10,
        h4('Abstract:'),
